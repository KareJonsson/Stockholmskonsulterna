...
public class PredefMax implements ArithmeticEvaluable 
{

	ArithmeticEvaluable ae_1;
	ArithmeticEvaluable ae_2;

	public PredefMax(ArithmeticEvaluable ae_1, ArithmeticEvaluable ae_2)
	{
		this.ae_1 = ae_1;
		this.ae_2 = ae_2;
	}
	...
	public void verify(Scope s) throws IntolerableException {
	  ...
	  public String reproduceExpression() {
		  return "max("+ae_1.reproduceExpression()+", "+ae_2.reproduceExpression()+")";
	  }
