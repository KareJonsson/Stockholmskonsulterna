...
public class ComparisonOperatorSmallerEqual extends ComparisonOperator
{

  public ComparisonOperatorSmallerEqual(String _filename, int _line, int _column)
  {
